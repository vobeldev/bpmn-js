...
export function importBpmnDiagram(diagram, definitions, bpmnDiagram) {
  ...
  function render(definitions, bpmnDiagram) {
    ...
    // walker.handleDefinitions(definitions, definitions.diagrams[0]);

    // console.log(definitions);

    // walker = new BpmnTreeWalker(visitor, translate);
    // walker.handleDefinitions(definitions, definitions.diagrams[1]);
