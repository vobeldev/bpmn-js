...
export default function CollapsedProcesses(eventBus, elementRegistry, elementFactory, overlays, canvas, bpmnReplace, diagramUtil) {
...
CollapsedProcesses.$inject = [ 'eventBus', 'elementRegistry', 'elementFactory', 'overlays', 'canvas', 'bpmnReplace', 'diagramUtil' ];